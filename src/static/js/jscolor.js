	...
	pub : function (targetElement, opts) {
		...
		function drawPicker () {
			...
			if (THIS.container === window.document.body) {
				...
				let left = parseFloat(targetElement.style.left);
				let top = parseFloat(targetElement.style.top);
				let height = parseFloat(targetElement.style.height);
				jsc._drawPosition(THIS, left-30, top+10, 'relative', false);
			}
